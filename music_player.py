...
class MusicPlayer:
  ...
  def __init__(self,root):
    ...
    playbtn = Button(buttonframe,text="REPEAT",command=self.repeat,width=8,height=1,font=("times new roman",16,"bold"),fg="navyblue",bg="gold").grid(row=0,column=4,padx=10,pady=5)
  ...
  def play_all(self):
    ...
    lists_of_songs = os.listdir("D:/FRIDAY/music player/music/") #path of the folder for music
    for song in lists_of_songs:
      if song.endswith(".mp3"):
          file_path = "D:/FRIDAY/music player/music/" + song #path of the folder for music + song
